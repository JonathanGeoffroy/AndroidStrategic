...
public class App extends Game {
	public static final String TEXTURES_DIR = "data/img/textures/", DIALOGS_DIR = "data/img/fighters/dialogs/", FIGHTERS_DIR = "data/img/fighters/", FONTS_DIR = "data/img/fonts", SOUNDS_DIR = "data/sounds/sounds/", MUSICS_DIR = "data/sounds/musics/";
